...
function Swimming () {
    return (
        <>
            <Nav />
            <div className="hero min-h-screen flex justify-end items-center pr-60" style={{backgroundImage: `url("public/images/SwimmingImg.jpg")`}}>
            </div>
            <div className="flex justify-center items-center my-8">
                <span className="badge badge-lg h-10 w-36 bg-base-100 shadow-xl font-semibold" style={{ backgroundColor: '#E76F6D', color: '#fff' }}>Swimming</span>
            </div>
