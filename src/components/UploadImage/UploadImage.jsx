...
const UploadImage = ({setImage}) => {
  ...
  const postImage = async (image) => {
    ...
    const response = await API.post(`${uploadImageRoute}`, requestData, { headers: { "Content-Type": "multipart/form-data" } });
  ...
  return (
      <>
        {showDropzone &&
          <div id="dropzone" className="flex items-center justify-center w-full" {...getRootProps()}>
